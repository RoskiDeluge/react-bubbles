...
A token is used to authenticate a user. It can be saved to localStorage so that the user can navigate to private routes even after refreshing the page or navigating away from the page. 

- [ ] What steps can you take in your web apps to keep your data secure?

Use an authentication flow to assign a token to each user. 

- [ ] Describe how web servers work.

A server can be thought as a computer or as the API code that handles HTTP requests from a client. When a request comes in from a client a server locates the appropriate request in its code and returns the response. 
